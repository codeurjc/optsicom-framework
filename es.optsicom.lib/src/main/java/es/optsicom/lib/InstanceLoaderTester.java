...
/**
 * This class loads all instances in the selected useCase (or default useCase)
 * and calls to it's toString() method. This class is helpful to test the
 * correct implementation of instance loading code
 */
