...
public class FileInstancesRepositoryWithLoader extends FileInstancesRepository {
	...
	public FileInstancesRepositoryWithLoader(boolean populate, InstanceLoader instanceLoader) {
		this(FileInstancesRepository.DEFAULT_INSTANCE_FILE_DIR, FileInstancesRepository.DEFAULT_USE_CASE, populate, instanceLoader);
	}
	...
	public FileInstancesRepositoryWithLoader(File instancesDir, String useCase, boolean populate, InstanceLoader instanceLoader) {
