...
public class ReportConfiguration implements Serializable {
	...
	public ReportConfiguration(List<Long> expId, List<Long> methods, boolean bestValues, boolean configuration) {
		super();
		this.expId = expId;
	...
	public String toString() {
		return "ReportConfiguration [expId=" + expId + ", methods=" + methods + ", bestValues=" + bestValues
