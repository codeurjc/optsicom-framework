...
public class ReportRest {
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((reportConfiguration == null) ? 0 : reportConfiguration.hashCode());
		result = prime * result + ((reportTables == null) ? 0 : reportTables.hashCode());
		return result;
	}
	...
	public String toString() {
		return "ReportRest [reportConfiguration=" + reportConfiguration + ", reportTables=" + reportTables + "]";
	}
