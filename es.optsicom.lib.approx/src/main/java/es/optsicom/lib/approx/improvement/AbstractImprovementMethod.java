...
public abstract class AbstractImprovementMethod<S extends Solution<I>, I extends Instance> implements
	...
	/**
	 * This method could be called by subclases when they found a new bestSolution
	 * in the improvement process. The solution doesn't need to be copied or 
	 * cloned. All the relevant information will be captured in this method.   
	 * @param solution
	 */
	...
	/**
	 * This method could be called by subclases when they found a new bestSolution
	 * in the improvement process. This method is provided to be used by improvement 
	 * methods that no use Solution class in the improvement process. If the method
	 * uses Solution class, it should be call to {@link #newBestSolutionFound(Solution)}.   
	 * @param solution
	 */
