...
public class VariableNeighbourhoodDescent<S extends Solution<I>, I extends Instance> extends
		VariableNeighbourhoodSearch<S, I> {

	public VariableNeighbourhoodDescent(Constructive<S, I> constructive, List<ImprovementMethod<S, I>> improvementMethods, int maxIterWoImpr) {
