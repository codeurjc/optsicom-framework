 ...
 */
public class MemeticAlgorithm<S extends Solution<I>, I extends Instance> extends AbstractApproxMethod<S, I> {
	...
	public MemeticAlgorithm(Constructive<S, I> constructive, ImprovementMethod<S, I> improvement,
