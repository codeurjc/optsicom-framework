...
public class SolutionDistanceInfo<D extends DistanceCalculator<S, I>, S extends Solution<I>, I extends Instance>
		implements Comparable<SolutionDistanceInfo<D, S, I>> {
