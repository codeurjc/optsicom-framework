...
public class BasicImprovementMethod<S extends Solution<I>, I extends Instance> extends MovementImprovementMethod<S, I>
	...
	private void applyMovement() {
		...
		// if(!MathUtil.efectiveEquals(originalWeight +
		// bestIncrement,solution.getWeight())){
		// throw new RuntimeException("Applying the movement doesn't increment
		// the solution value as expected. It should be "+(originalWeight +
		// bestIncrement)+" and is "+solution.getWeight());
		// }
	...
	public static <S extends Solution<I>, I extends Instance> BasicImprovementMethod<S, I> create(
			MovementGenerator<S, I> movementGenerator, Mode mode) {
		return new BasicImprovementMethod<S, I>(movementGenerator, mode);
	}
