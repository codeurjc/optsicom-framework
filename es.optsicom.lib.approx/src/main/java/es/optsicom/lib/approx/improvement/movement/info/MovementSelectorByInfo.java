...
//			Object movement2);
	...
	// This is used in TabuSearch to know if movement met the aspiration criteria
	...
	//   forma incremental. Ahora hay que hacerlo con el método selectMovementToApply
	//   de esta misma clase. Eso permitirá aplicar criterios globales a la selección, 
	//   no sólo comparar dos movimientos entre sí. 
	// * Hay que hacer una prueba haciendo que Info sea Double como se estaba 
	//   usando ahora. Así podemos hacer pruebas y ver si estas nuevas implementaciones
	//   son correctas. 
}
