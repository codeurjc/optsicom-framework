...
public class ReducedVariableNeighbourhoodSearch<S extends Solution<I>, I extends Instance>
		extends VariableNeighbourhoodSearch<S, I> {

	public ReducedVariableNeighbourhoodSearch(Constructive<S, I> constructive, List<Neighbourhood<S, I>> neighbourhoods,
			int maxIterWoImpr) {
