...
public class SimpleDynamicConstPathRelinking<S extends Solution<I>, I extends Instance> extends AbstractPathRelinking<S, I> {

	protected int numIter;
	

	public SimpleDynamicConstPathRelinking(int numIter, Constructive<S, I> constructive, ImprovementMethod<S, I> improvement,
	...
	protected void internalCalculateSolution(long duration) {
		...
		if (duration == -1) {
			...
			for (int i = eliteSetSize; i < numIter; i++) {
				doSimpleDynEliteSetIteration(finishTime);
			}
