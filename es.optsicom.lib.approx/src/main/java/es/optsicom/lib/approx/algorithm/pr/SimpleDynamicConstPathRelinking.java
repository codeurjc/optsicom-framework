...
public class SimpleDynamicConstPathRelinking<S extends Solution<I>, I extends Instance>
		extends AbstractPathRelinking<S, I> {

	protected int numIter;

	public SimpleDynamicConstPathRelinking(int numIter, Constructive<S, I> constructive,
