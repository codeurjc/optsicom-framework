...
public class CreateDummyData {
	...
	private static void createDummyData(DerbyDBManager dbManager) {
		...
		for(int i=0; i<NUM_INSTANCES; i++){
			...
			DBProperties dbProperties = new DBProperties(properties);
			InstanceDescription instance = new InstanceDescription(dbProperties);
		...
		for(int i=0; i<NUM_ALGORITHM; i++){
			...
			DBProperties dbProperties = new DBProperties(properties);
			MethodDescription method = new MethodDescription(dbProperties);
