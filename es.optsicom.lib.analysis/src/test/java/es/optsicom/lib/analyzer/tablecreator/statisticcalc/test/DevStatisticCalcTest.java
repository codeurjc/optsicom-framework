...
public class DevStatisticCalcTest {
	...
	public void testRelativizeDoubleArrayNumber() {
		...
		Double[] expectedRelValues = {(bestValue-1.0)/bestValue, (bestValue-2.0)/bestValue, (bestValue-4.0)/bestValue};
		...
		expectedRelValues = new Double[] {(2.0-bestValue)/bestValue, (3.0-bestValue)/bestValue, (5.0-bestValue)/bestValue};
