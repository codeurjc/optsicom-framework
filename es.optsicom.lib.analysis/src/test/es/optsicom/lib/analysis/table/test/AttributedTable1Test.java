...
public class AttributedTable1Test {
	...
	public static void main(String[] args) {
		...
		showTable(attributedTable,new String[]{"time","method"},new String[]{"instance"});
		showTable(attributedTable,new String[]{"time"},new String[]{"instance","method"});
		showTable(attributedTable,new String[]{"method"},new String[]{"instance","time"});
				
	}

	private static void showTable(AttributedTable attributedTable, String[] rows, String[] cols) {
