...
/**
 * @author paco Class that represents the file to export
 */
public class Report implements Serializable {
	 ...
	 *            Sheet to add
	 * @param position
	 *            Position where the sheet is added
	 * @throws ReportException
	 */
	...
	/**
	 * Adds a set of pages at the end of the report in the order they are
	 * returned by the <code>pages</code> iterator.
	 * 
	 * @param pages
	 *            The set of pages to add
	 */
