		...
		StatisticGroup[] statisticGroups = {
				StatisticGroup
						.createMultipleStatisticGroup(new LastEventRP(
								Event.OBJ_VALUE_EVENT, SummarizeMode.MAX, -1,
								Source.VALUE), new Statistic[] {
				...
				StatisticGroup
						.createMultipleStatisticGroup(new LastEventRP(
								Event.OBJ_VALUE_EVENT, SummarizeMode.MIN, -1,
								Source.VALUE), new Statistic[] {
								new Statistic(new DevStatisticCalc(bestMode),
										"Dev (Min)"),
								new Statistic(
								...
								new Statistic(
										new NonRelativizerStatisticCalc(
												SummarizeMode.FIRST,
												NumberType.DECIMAL), "Value (Min)") }),

				StatisticGroup
						.createMultipleStatisticGroup(new LastEventRP(
								Event.OBJ_VALUE_EVENT, SummarizeMode.AVERAGE,
								-1, Source.VALUE), new Statistic[] {
								new Statistic(new DevStatisticCalc(bestMode),
										"Dev (Avg)"),
								new Statistic(
										new NumBestStatisticCalc(bestMode),
