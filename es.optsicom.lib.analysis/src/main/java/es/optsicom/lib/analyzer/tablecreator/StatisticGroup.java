...
public class StatisticGroup {
	...
	public static StatisticGroup createSimpleStatisticGroup(RawProcessor rawProcessor, Statistic... statistics) {
		return new StatisticGroup(rawProcessor, new Statistic[][] { statistics });
	}

	public static StatisticGroup createMultipleStatisticGroup(RawProcessor rawProcessor, Statistic[]... statistics) {
