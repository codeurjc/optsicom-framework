...
public class LoadAllExperimentManager implements ExperimentManager {
	...
	private Map<InstanceDescription, Map<MethodDescription, List<Execution>>> data = 
		new HashMap<InstanceDescription, Map<MethodDescription, List<Execution>>>();

	public LoadAllExperimentManager(Experiment experiment,
			ExperimentRepositoryManager manager) {
	...
	public ExperimentManager createFilteredExperimentManager(
		...
		return new FilteredExperimentManager(manager, this, instanceFilter,
				methodFilter);
	}
	...
	public long getMaxTimeLimit(List<MethodDescription> subsetMethods,
			List<InstanceDescription> subsetInstances) {
		return manager.getMaxTimeLimit(experiment, subsetMethods,
				subsetInstances);
	}
