...
public class DerbyDBManager extends DBManager {
	...
	public DerbyDBManager(String dir) throws SQLException {
		this(new File(dir));
	}
	...
	protected void connect() throws SQLException {
		...
		File derbyDatabaseDir = new File(dbDir, DERBY_DATA_DIR);
		...
		try {
			...
			conn = DriverManager
					.getConnection("jdbc:derby:"+DATABASE_NAME+";create=true");
		...
		properties.put("eclipselink.jdbc.url", "jdbc:derby:"+DATABASE_NAME);
