...
public class MemoryExperimentManager implements ExperimentManager {
	...
	public MemoryExperimentManager(Experiment experiment,
			Map<InstanceDescription, Map<MethodDescription, List<Execution>>> data,
	...
	public MemoryExperimentManager(Experiment experiment, List<Execution> executions,
			Map<MethodDescription, String> experimentMethodNames) {
	...
	private Map<InstanceDescription, Map<MethodDescription, List<Execution>>> createDataFromExecutions(
	...
	public ExperimentManager createFilteredExperimentManager(ElementFilter instanceFilter, ElementFilter methodFilter) {
		...
		return new FilteredExperimentManager(null, this, instanceFilter, methodFilter);
	}
