...
/**
 * Creates a new ExperimentManager as fusion of several ExperimentManagers. If two or more
 * ExperimentManagers contain the same Method, only the method of the first ExperimentManager
 * will be used. The instances of the merged ExperimentManager will be the common instances
 * between all ExperimentManagers being merged.
 *
 * @author mica
 *
 */
