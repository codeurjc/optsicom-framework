...
public class ElementDescriptionSerializer extends JsonSerializer<ElementDescription> {
	...
	@Override
	public void serialize(ElementDescription element, JsonGenerator jgen, SerializerProvider provider)
	...
	private void writeField(String propertyName, ElementDescription element, JsonGenerator jgen,
			Set<String> writtenProps) throws IOException, JsonGenerationException {
