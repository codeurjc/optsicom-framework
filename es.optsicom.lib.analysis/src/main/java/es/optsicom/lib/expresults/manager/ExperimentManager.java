...
public interface ExperimentManager {
	...
	/**
	 * Returns the maximum time limit configured in the instances of this
	 * experiment.
	 * 
	 * @return
	 */
	...
	public abstract ExperimentManager createFilteredExperimentManager(ElementFilter instanceFilter,
			ElementFilter methodFilter);

	public abstract ExperimentManager createFilteredExperimentManager(ElementFilter instanceFilter,
			String... methodsByExpName);

	public abstract long getTimeLimit(List<MethodDescription> subsetMethods, List<InstanceDescription> subsetInstances);

	public abstract long getMaxTimeLimit(List<MethodDescription> subsetMethods,
			List<InstanceDescription> subsetInstances);

	public abstract List<Execution> getExecutions(InstanceDescription instance, MethodDescription method);
