...
public class ObjectSorter {
	...
	public static <T extends Comparable<? super T>> int[] sort(T[] inArray, int begin, int end) {
	...
	public static <T extends Comparable<? super T>> int[] sort(T[] inArray) {
	 ...
	 * pivot element.
	 */
	private static <T extends Comparable<? super T>> void qSort(int[] map, T[] array, int low, int high) {
	...
	private static void swap(int[] map, Comparable<?>[] array, int idx1, int idx2) {
		int mapTemp;
		Comparable<?> arrayTemp;
